...
const Display = () => {
  ...
  const inputChange = (e) => {
    ...
    const filtered = cityState.list.filter((city) =>            //érkezett lista leszűrése...
  ...
  //ország és város kiválasztó függvények

  const handleCountryChange = (selectedCountryId) => {

    setSelectedCountry(selectedCountryId);
    setCity("");              // ország váltásnál üres a city...
    setFilteredCities([]);    // ország váltásnál a szűrés törlődik...
    setShowCity(true);        // igy lesz látható a város...
